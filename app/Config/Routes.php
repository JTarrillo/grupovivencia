...
$routes->get('dashboard/ventas/contratos/comprobantes/(:num)', 'D_ventas::comprobantes_ajax/$1'); // sin filter
$routes->post('dashboard/ventas/contratos/anular', 'D_ventas::anular_comprobante');
/* pelao gran puta */
