                                                            ...
                                                            if ($obj_invoices) {
                                                               foreach ($obj_invoices as $value) : ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <?php echo isset($value->property_address) ? $value->property_address : '-'; ?>
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php echo isset($value->property_reference) ? $value->property_reference : '-'; ?>
                                                                                    </td>
                                                                                    <td>
                                                                           ...
                                                                           $stilo = "label label-warning";
                                                                                    ...
                                                                                    <td>
                                                                                        <h6><?php echo format_number_moneda_soles($value->amount); ?>
                                                                                        </h6>
                                                                                    </td>
                                                                                    <td>
                                                                        ...
                                                                        if ($value->store_name == "Almacén general") { ?>
                                                                                        <span style="border-radius:10px"
                                                                                            class="label label-info"><?php echo $value->store_name; ?></span>
                                                                                        <?php } else { ?>
                                                                                        <span
                                                                                            style="border-radius:10px;color:white"
                                                                                            class="label theme-bg2"><?php echo $value->store_name; ?></span>
                                                                                        <?php } ?>
                                                                                    </td>
                                                                                        ...
                                                                                        <div class="operation">
                                                                                            <div class="btn-group">
                                                                                                <button type="button"
                                                                                                    ...
                                                                                                    title="Editar"
                                                                                                    onclick="edit_invoices('<?php echo $value->id; ?>');"><i
