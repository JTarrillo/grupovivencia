                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <span class="d-block m-t-5">Complete los datos para registrar una nueva compra</span>
                                            </div>
                                            <div class="card-block">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9 mb-3">
                                                            <textarea class="form-control" name="descripcion" rows="3" placeholder="Descripción de la compra"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9 mb-3">
                                                            <input type="text" class="form-control" name="clasificacion" placeholder="Clasificación">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-9 offset-sm-3">
                                                            <button type="submit" class="btn btn-primary">
                                                                <i class="feather icon-check"></i> Guardar Compra
                                                            </button>
                                                            <a href="/dashboard/tributario/compras" class="btn btn-secondary">
