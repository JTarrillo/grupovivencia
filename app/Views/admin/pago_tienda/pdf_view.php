...
<body>
  <div class="container" style="margin-top:-20px;">
    <div class="container">
      ...
      <h4 class="text-center">RUC: 20613043889</h2>
        <div class="d-flex flex-row-reverse bd-highlight">
          <p>
              <b>Cliente:</b> <?php echo $obj_invoices->name. " ".$obj_invoices->lastname;?><br/><b>Código:</b> <?php echo $obj_invoices->code; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Venta:</b> 000<?php echo $obj_invoices->id; ?><br />
              <b>Fecha:</b> <?php echo formato_fecha_dia_mes_anio_abrev($obj_invoices->date); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Hora:</b><?php echo formato_fecha_minutos($obj_invoices->date); ?>
            </p>
