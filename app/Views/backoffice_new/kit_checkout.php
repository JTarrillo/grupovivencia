                                ...
                                <div class="d-flex flex-column flex-xl-row">
                                    <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                        <div class="mt-n1">
                                            ...
                                            <div class="m-0">
                                                <form name="form" enctype="multipart/form-data" action="javascript:void(0);" method="post" class="form">
                                                            ...
                                                            <table class="table mb-3">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="fw-bold text-gray-700 fs-5">
                                                                        ...
                                                                        <td class="fs-5 text-dark fw-bolder">S/<?php echo format_number_miles_decimal($sub_total); ?></td>
                                                                    ...
                                                                    <tr class="fw-bold text-gray-700 fs-5">
                                                                        ...
                                                                        <td class="fs-5 text-dark fw-bolder">S/<?php echo format_number_miles_decimal($igv); ?></td>
                                                                        <td class="fs-5 text-dark fw-bolder"></td>
                                                                    </tr>
                                                                    <tr class="fw-bold text-gray-700 fs-5">
                                                                        <td></td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="fw-semibold fs-7 text-gray-600 mb-1">Puntos</div>
                                                    ...
                                                    <div class="row g-5 mb-11">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="row" style="justify-content: center;">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <button id="submit_monedero" onclick="wallet_pay();" class="btn-primary btn btn-block fw-bold fs-8 fs-lg-base" style="font-family: 'proximaNova';font-size: 16px !important; width: 100%;margin-top: 17px;"><i class="fa fa-usd" aria-hidden="true"></i> Pagar con Monedero - S/<?php echo format_number_miles_decimal($total_disponible); ?></button>
                                                                </div>
                                                                <div class="col-sm-4">
