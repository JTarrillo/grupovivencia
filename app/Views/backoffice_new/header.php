<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
    ...
    <div class="container-xxl d-flex flex-grow-1 flex-stack">
        ...
        <!-- NUEVO: Mostrar nombre y código en la parte superior derecha -->
        <div class="d-flex flex-column align-items-end me-5 d-none d-lg-flex">


        </div>
        <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
            <div class="d-flex align-items-center ms-2 ms-lg-3">
                <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px btn-color-info"
                    data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    <span class="svg-icon svg-icon-1">
                        <svg class="text-orange-mn" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                    ...
                    <div class="row g-0">
                        <div class="col-6">
                            <?php if (isset($obj_customer) && !empty($obj_customer->code)): ?>
                            <a target="_blank" href="<?php echo site_url() . "registro/" . $obj_customer->code; ?>"
                                class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                    <i class="fa fa-2x fa-user-plus svg-icon svg-icon-1"></i>
                                </span>
                                <span
                                    class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('Global.nuevo_socio'); ?></span>
                            </a>
                            <?php endif; ?>
                        </div>
                        <div class="col-6">
                            <a href="<?php echo site_url() . BACKOFFICE . "/directos"; ?>"
                        ...
                        <div class="col-6">
                            <a href="<?php echo site_url() . BACKOFFICE . "/plan"; ?>"
                        ...
                        <div class="col-6">
                            <a href="<?php echo site_url() . BACKOFFICE . "/cobros"; ?>"
                                class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                                <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                    <i class="fa fa-2x fa-usd svg-icon svg-icon-1"></i>
                                </span>
                                <span
                                    class="fs-5 fw-semibold text-gray-800 mb-0"><?php echo lang('Global.cobros'); ?></span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex align-items-center ms-2 ms-lg-3">
                <a href="#" class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px btn-color-warning"
            ...
            <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                    ...
                    <?php
                    if (isset($obj_customer) && !empty($obj_customer->avatar)) { ?>
                    <img src="<?php echo site_url() . "avatar/" . $obj_customer->id . "/" . $obj_customer->avatar; ?>"
                        alt="avatar">
                    <?php } else { ?>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            <div class="me-5">
                                <img alt="Logo" src="<?php echo site_url() . "assets/front/img/logo/vive.png"; ?>"
                                    alt="logo" width="50" />
                            </div>
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    ...
                                    <?php } else { ?>
                                    <span
                                        class="badge badge-light-danger fw-bold fs-8 px-2 py-1 ms-2"><?php echo lang('Global.inactivo'); ?></span>
                                    <?php } ?>
                                </div>
                                <a
                    ...
                    <div class="menu-item px-5">
                        <a href="<?php echo site_url() . "backoffice_new/perfil"; ?>"
                            class="px-5 linked-icon-items"><?php echo lang('Global.mi_perfil'); ?></a>
                    </div>
                    <div class="separator my-2"></div>
                    ...
                    <div class="menu-item px-5">
                        <a id="btn-exit" href="<?php echo site_url() . "iniciar-sesion"; ?>"
                            class="px-5 linked-icon-items"><?php echo lang('Global.salir'); ?></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE; ?>"
                                                    class="menu-link <?php echo $panel_active; ?>">
                                                    <span
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/planes"; ?>"
                                                    class="menu-link <?php echo $plan_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span class="fs-6 fw-bold text-gray-800">Proyectos
                                                            Inmobiliarios</span>
                                                        <span class="fs-7 fw-semibold text-muted-2">Real Estate</span>
                                                    </span>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/cobros"; ?>"
                                                    class="menu-link <?php echo $cobros_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span
                                                            class="fs-6 fw-bold text-gray-800"><?php echo lang('Global.cobros'); ?></span>
                                                        <span class="fs-7 fw-semibold text-muted-2">Cobros de
                                                            Beneficios</span>
                                                    </span>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/documentos"; ?>"
                                                    class="menu-link <?php echo $documentos_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/perfil"; ?>"
                                                    class="menu-link <?php echo $perfil_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span
                                                            class="fs-6 fw-bold text-gray-800"><?php echo lang('Global.mi_perfil'); ?></span>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/unilevel"; ?>"
                                                    class="menu-link <?php echo $unilevel_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="menu-item p-0 m-0">
                                                <a href="<?php echo site_url() . BACKOFFICE . "/historial"; ?>"
                                                    class="menu-link <?php echo $historial_active; ?>">
                                                    <span
                                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        <span class="svg-icon svg-icon-orange svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                    <h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">
                                        <?php echo lang('Global.mas_opciones'); ?></h4>
                                    <div class="menu-item p-0 m-0">
                                        <a href="<?php echo site_url() . BACKOFFICE . "/directos"; ?>"
                                            class="menu-link py-2 <?php echo $directos_active; ?>">
                                            <span class="menu-title">Directos</span>
                                        </a>
                                    </div>
                                    <?php // Menú Renovación anual visible para ambos tipos de agentes (pruebas) ?>
                                    <div class="menu-item p-0 m-0">
                                        <a href="<?php echo site_url() . BACKOFFICE . "/renovacion"; ?>"
                                            class="menu-link py-2">
                                            <span class="menu-title">Renovación anual</span>
                                        </a>
                                    </div>
                                    <!-- <div class="menu-item p-0 m-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                        <a href="<?php echo site_url() . BACKOFFICE . "/facturas"; ?>"
                                            class="menu-link py-2 <?php echo $facturas_active; ?>">
                                            <span class="menu-title">Mis Compras</span>
                                        </a>
                                    </div>
                                    <div class="menu-item p-0 m-0">
                                        <a href="<?php echo site_url() . BACKOFFICE . "/ticket"; ?>"
                                            class="menu-link py-2 <?php echo $soporte_active; ?>">
                                            <span class="menu-title">Soporte</span>
                                        </a>
                                    </div>
                                    <div class="menu-item p-0 m-0">
                                        <a href="<?php echo site_url() . BACKOFFICE . "/sugerencias"; ?>"
                                            class="menu-link py-2 <?php echo $sugerencias_active; ?>">
