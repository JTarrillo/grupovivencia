...
class ContractModel extends Model
{
    ...
    protected $allowedFields = [
        'lot_id', 'customer_id', 'payment_plan_id', 'contract_number', 'total_amount', 'down_payment', 'financed_amount', 'monthly_payment', 'interest_rate', 'contract_date', 'start_date', 'end_date', 'status', 'contract_file', 'notes', 'financing_months',
        'is_reserved', 'reservation_amount', 'reservation_date', 'contract_type', 'voucher_url'
    ];
