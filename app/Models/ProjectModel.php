...
class ProjectModel extends Model
{
    ...
    protected $allowedFields = ['name', 'code', 'description', 'image', 'total_lots', 'available_lots', 'base_price_per_sqm', 'base_interest_rate', 'status', 'payment_plan_id', 'created_at', 'updated_at', 'department_id', 'province_id', 'district_id', 'down_payment_type', 'min_down_payment_percentage', 'min_down_payment_fixed', 'max_financing_months'];
